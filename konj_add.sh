...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='konjungate.conf'
ORIGFOLDER='/root/.konj'
CONFIGFOLDER="/root/.konj-$1"
COIN_DAEMON='konjungated'
COIN_CLI='konjungate-cli'
...
read -p "KONJ Port: " -i $DEFAULT_COIN_PORT -e COIN_PORT
: ${COIN_PORT:=$DEFAULT_COIN_PORT}
}
...
/usr/local/bin/konjungate-cli -conf=$CONFIGFOLDER/$CONFIG_FILE -datadir=$CONFIGFOLDER \$@
EOF
...
##### Main #####
clear
[ $# -eq 0 ] && { echo "Usage: $0 coin_suffix"; exit 1; }
setup_node
